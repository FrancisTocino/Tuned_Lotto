<html>
<head>
<title>IMPORTACION_EL_GORDO _DE LA PRIMITIVA.PHP</title>
...
//VACIAMOS LA TABLA PARA IMPORTAR LOS DATOS NUEVOS
		...
		while(!feof($fp))
		{
			echo '//LEMEOS UNA LINEA';
			$linea = fgets($fp);
			echo '//EXTTRAEMOS LOS CAMPOS SEPRADOS POR COMAS';
			$campos = explode(",", $linea);
			echo '// LEO LA PRIMERA LINEA';
			$fecha_elgordo = $campos[0];
			echo '$fecha_elgordo:' . $fecha_elgordo;
			switch ($fecha_elgordo)
			{
				case 'FECHA':
					echo '<li>DETECTADO CABECERA, DESCARTADADA PARA LA IMPORTACION (OK)... </li><br>';
					echo('$fecha_bonoloto: '.$fecha_elgordo);
					break;
				...
				default: //PASO LOS VALORES PARA IMPORTAR
						...
						$fecha_elgordo=	combierte_fecha($campos[0]);
						$numero1=		$campos[1];
						$numero2=		$campos[2];
						$numero3=		$campos[3];
						$numero4=		$campos[4];
